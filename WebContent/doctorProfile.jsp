 ...
 <div id="content">
	...
	<div class ="profile-card">
		...
		<div class="main-container">
			...
			<p><i class="fa fa-phone info" aria-hidden="true"><br></i>Phone:<%=rs.getString(4)%></p>
			<p><i class="fa fa-id-card info" aria-hidden="true"><br></i>Age:<%=rs.getInt(3)%></p>
			<p><i class="fa fa-phone info" aria-hidden="true"><br></i>Specialistation:<%=rs.getString(5)%></p>
